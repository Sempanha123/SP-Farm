...
# Set database URL dynamically from app paths if not specified
if not config.get_main_option("sqlalchemy.url") or config.get_main_option("sqlalchemy.url") == "sqlite:///spfarm.db":

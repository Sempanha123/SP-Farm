...
################################################################################
## Form generated from reading UI file 'set_location_dialog.ui'
##
...
class Ui_set_location_dialog(object):
    def setupUi(self, set_location_dialog):
        if not set_location_dialog.objectName():
            set_location_dialog.setObjectName(u"set_location_dialog")
        set_location_dialog.resize(288, 135)
        set_location_dialog.setStyleSheet(u"QWidget {\n"
...
"\n"
"")
        self.gridLayout = QGridLayout(set_location_dialog)
        self.gridLayout.setObjectName(u"gridLayout")
        self.enable = QCheckBox(set_location_dialog)
        self.enable.setObjectName(u"enable")

        self.gridLayout.addWidget(self.enable, 1, 0, 1, 1)

        self.frame = QFrame(set_location_dialog)
        ...
        self.coordinate_line_edit = QLineEdit(self.frame)
        self.coordinate_line_edit.setObjectName(u"coordinate_line_edit")

        self.gridLayout_2.addWidget(self.coordinate_line_edit, 0, 1, 1, 1)
        ...
        self.frame_3 = QFrame(set_location_dialog)
        ...
        icon = QIcon()
        icon.addFile(u":/icons/images/save.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/images/close.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.retranslateUi(set_location_dialog)

        QMetaObject.connectSlotsByName(set_location_dialog)
    # setupUi

    def retranslateUi(self, set_location_dialog):
        set_location_dialog.setWindowTitle(QCoreApplication.translate("set_location_dialog", u"Fake Location", None))
        self.enable.setText(QCoreApplication.translate("set_location_dialog", u"Enable", None))
        self.label.setText(QCoreApplication.translate("set_location_dialog", u"Coordinate", None))
        self.save.setText(QCoreApplication.translate("set_location_dialog", u"Save", None))
        self.cancel.setText(QCoreApplication.translate("set_location_dialog", u"Cancel", None))
    # retranslateUi

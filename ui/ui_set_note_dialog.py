...
################################################################################
## Form generated from reading UI file 'set_note_dialog.ui'
##
...
class Ui_set_note_dialog(object):
    def setupUi(self, set_note_dialog):
        if not set_note_dialog.objectName():
            set_note_dialog.setObjectName(u"set_note_dialog")
        set_note_dialog.resize(345, 157)
        icon = QIcon()
        icon.addFile(u":/icons/images/notes.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        set_note_dialog.setWindowIcon(icon)
        set_note_dialog.setStyleSheet(u"QWidget {\n"
...
"    border: 1px solid #5a9bd5;   /* Highlight border on focus */\n"
"}\n"
"\n"
"\n"
"")
        self.gridLayout = QGridLayout(set_note_dialog)
        self.gridLayout.setObjectName(u"gridLayout")
        self.frame = QFrame(set_note_dialog)
        ...
        self.notes_text_edit = QPlainTextEdit(self.frame)
        self.notes_text_edit.setObjectName(u"notes_text_edit")
        self.notes_text_edit.setPlainText(u"")

        self.gridLayout_2.addWidget(self.notes_text_edit, 0, 1, 1, 1)


        self.gridLayout.addWidget(self.frame, 1, 0, 1, 1)

        self.frame_3 = QFrame(set_note_dialog)
        ...
        self.retranslateUi(set_note_dialog)

        QMetaObject.connectSlotsByName(set_note_dialog)
    # setupUi

    def retranslateUi(self, set_note_dialog):
        set_note_dialog.setWindowTitle(QCoreApplication.translate("set_note_dialog", u"Fake Location", None))
        self.label.setText(QCoreApplication.translate("set_note_dialog", u"Notes", None))
        self.save.setText(QCoreApplication.translate("set_note_dialog", u"Save", None))
        self.cancel.setText(QCoreApplication.translate("set_note_dialog", u"Cancel", None))
    # retranslateUi
